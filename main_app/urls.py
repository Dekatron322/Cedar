...
from main_app.EditResultView import EditResultView, EditStResultView, EditTtResultView
...
urlpatterns = [
    ...
    path("select_term/", hod_views.select_term, name='select_term'),
    ...
    path("student/check/<int:student_id>", hod_views.check_result, name='check_result'),
    path("student/checks/<int:student_id>", hod_views.check_ssresult, name='check_ssresult'),
    path("student/checkt/<int:student_id>", hod_views.check_ttresult, name='check_ttresult'),
    path("student/checkc/<int:student_id>", hod_views.check_cresult, name='check_cresult'),
    ...
    path('hod/view/result/', hod_views.hod_view_result,
         name='hod_view_result'),
    path('hod/view/ssresult/', hod_views.hod_view_ssresult,
         name='hod_view_ssresult'),
    path('hod/view/ttresult/', hod_views.hod_view_ttresult,
         name='hod_view_ttresult'),
    path('hod/view/history/', hod_views.check_result_history,
    ...
    path("staff/stresult/add/", staff_views.staff_add_stresult, name='staff_add_stresult'),

    path("staff/ttresult/add/", staff_views.staff_add_ttresult, name='staff_add_ttresult'),

    path("staff/result/edit/", EditResultView.as_view(),
         name='edit_student_result'),
    path("staff/stresult/edit/", EditStResultView.as_view(),
         name='edit_student_stresult'),
    path("staff/ttresult/edit/", EditTtResultView.as_view(),
         name='edit_student_ttresult'),
    path('staff/result/fetch/', staff_views.fetch_student_result,
         name='fetch_student_result'),

    path('staff/stresult/fetch/', staff_views.fetch_student_stresult,
         name='fetch_student_stresult'),

    path('staff/ttresult/fetch/', staff_views.fetch_student_ttresult,
         name='fetch_student_ttresult'),
